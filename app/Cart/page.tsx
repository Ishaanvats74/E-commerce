        ...
        <>
          <div className="bg-gray-300 h-auto p-5  overflow-auto">
            <div className="bg-white h-auto rounded-md p-6">
              ...
              {cart.map((item) => (
                <div className="mt-5 space-y-10 h-auto" key={item.id}>
                    ...
                    <div className="flex flex-col justify-between w-full">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <div className="flex border border-amber-400 rounded-full overflow-hidden text-sm">
                          <button className="w-8 h-8 border-r border-amber-400">
                            -
                          </button>
                          <button className="w-8 h-8">{item.quantity}</button>
                          <button className="w-8 h-8 border-l border-amber-400">
                            +
                          </button>
                        </div>
                        <button className="text-red-600 text-sm hover:underline" onClick={()=>handleDelete(item)}>
                          Delete
                        </button>
                      </div>
                    </div>
